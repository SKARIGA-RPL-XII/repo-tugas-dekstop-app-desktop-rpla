    ...
    },
    {
      ...
      svg: (
        <svg width="50" height="50" viewBox="0 0 50 50" fill="none">
          ...
          />
          <path
            d="M37 18.25L24.5 12L12 18.25V30.75L24.5 37L37 30.75V18.25Z"
            stroke="#009966"
            strokeWidth="2"
            strokeLinejoin="round"
          />
          <path
            d="M12 18.25L24.5 24.5M24.5 24.5V37M24.5 24.5L37 18.25M30.75 15.125L18.25 21.375"
            stroke="#009966"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    },
    {
      ...
      svg: (
        <svg width="50" height="50" viewBox="0 0 50 50" fill="none">
          ...
          <path
            d="M35.4998 23.8368H35.2945L33.1677 17.615L14.9128 23.8368"
            stroke="#E000AD"
            strokeWidth="2"
            strokeLinecap="square"
          />
          <path
            d="M27.9163 29.6667C27.9163 30.4402 27.6091 31.1821 27.0621 31.7291C26.5151 32.276 25.7732 32.5833 24.9997 32.5833C24.2261 32.5833 23.4843 32.276 22.9373 31.7291C22.3903 31.1821 22.083 30.4402 22.083 29.6667Z"
            stroke="#E000AD"
            strokeWidth="2"
            strokeLinecap="square"
          />
          <path
            d="M36.0832 23.8333V35.5H13.9165V23.8333H36.0832Z"
            stroke="#E000AD"
            strokeWidth="2"
            strokeLinecap="square"
          />
