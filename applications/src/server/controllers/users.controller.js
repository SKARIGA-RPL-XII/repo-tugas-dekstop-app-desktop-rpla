...
export class UsersController {
  static async getUsers(req, res) {
    try {
      const { data, count, page = 1, limit = 10 } = await Users.getAll(supabase, req.query);
  ...
  static async createUser(req, res) {
    try {
      ...
      return errorResponse(res, "Internal Server Error during creation", 500, formatFieldError(error.message));
    }
  }
  ...
  static async updateUser(req, res) {
    try {
      ...
      return errorResponse(res, "Internal Server Error during update", 500, formatFieldError(error.message));
    }
  }
  ...
  static async deleteUser(req, res) {
    try {
      ...
      return errorResponse(res, "Internal Server Error during deletion", 500, error.message);
    }
  }
}
